...
function NavBar() { 
  ...
  <nav className="md:pl-4 h-20 font-sans font-semibold border-b-2 shadow-lg flex items-center justify-between sticky top-0 z-40 bg-white min-w-[440px] ">
   <div className="flex gap-6 items-center ">
    ...
    <ul typeof="none" className="laptop:flex gap-4  items-center hidden ">
    <a href="/" className="hover:underline underline-offset-4">HOME</a>
      <a href="/Cumfy/Men" className="hover:underline underline-offset-4" 
       onClick={(e)=>{
        e.preventDefault();
        dispatch(stateAction.byTitle("Men"))
        navigate("/Cumfy/Men");}}>MEN</a>
      <a href="/Cumfy/Women" className="hover:underline underline-offset-4"  onClick={(e) => {
     e.preventDefault();
     dispatch(stateAction.byTitle("Women")); 
     navigate("/Cumfy/Women");
   }}>WOMEN</a>
      <a href="/Cumfy/Bag" className="hover:underline underline-offset-4" 
      onClick={(e)=>{
      e.preventDefault();
      dispatch(stateAction.byTitle("Bag"));
      navigate("/Cumfy/Bag")}}>BAGS</a>
      <a href="/Cumfy/Home & Living" onClick={(e)=>{
        e.preventDefault();
        dispatch(stateAction.byTitle("Home & Living"))
        navigate("/Cumfy/Home & Living")}} className="hover:underline underline-offset-4">LIVING</a>
      <a href="/Cumfy/Shoe" className="hover:underline underline-offset-4" onClick={(e)=>{
         e.preventDefault();
        dispatch(stateAction.byTitle("Shoe"))
        navigate("/Cumfy/Shoe")}}>SHOES</a>
    </ul>
    </div>
    ...
    <Input
      ...
      <WishList></WishList>
      <Cart></Cart>
      {isAuth?<MenuDefault email={email}/>:
      <SignIn/>}
      
      <button className="cursor-pointer laptop:hidden" onClick={toggleNavbar}>
  ...
  {mobileDrawerOpen && <div className=" sticky top-16 z-50  laptop:hidden bg-white border-2 shadow-lg  ">
        <ul typeof="none" className=" mt-2 flex flex-col items-center gap-3  ">
        <a href="/" className="hover:underline underline-offset-4">HOME</a>
      <a href="/Cumfy/Men" className="hover:underline underline-offset-4" onClick={(e)=>{
        e.preventDefault();
        dispatch(stateAction.byTitle("Men"))
        navigate("/Cumfy/Men");
        setMobileDrawerOpen(false);}}>MEN</a>
      <a href="/Cumfy/Women" className="hover:underline underline-offset-4" onClick={(e) => {
     e.preventDefault();
     dispatch(stateAction.byTitle("Women")); 
     navigate("/Cumfy/Women");
     setMobileDrawerOpen(false);
      ...
      <a href="/Cumfy/Bag" className="hover:underline underline-offset-4" onClick={(e)=>{
      e.preventDefault();
      dispatch(stateAction.byTitle("Bag"));
      navigate("/Cumfy/Bag")
      setMobileDrawerOpen(false);}}>BAGS</a>
      <a href="/Cumfy/Home & Living" className="hover:underline underline-offset-4 " onClick={(e)=>{
        e.preventDefault();
        dispatch(stateAction.byTitle("Home & Living"))
        navigate("/Cumfy/Home & Living")
        setMobileDrawerOpen(false);}} >HOME & LIVING</a>
      <a href="/Cumfy/Shoe" className="hover:underline underline-offset-4" onClick={(e)=>{
         e.preventDefault();
        dispatch(stateAction.byTitle("Shoe"))
        navigate("/Cumfy/Shoe")
        setMobileDrawerOpen(false);}}>SHOES</a>
    </ul>
        </div>}</>}
  ...
  {mobileDrawerOpen && <div className=" sticky top-16 z-50  laptop:hidden bg-white border-2 shadow-lg  ">
      ...
      <a className="hover:underline underline-offset-4">WOMEN</a>
      <a className="hover:underline underline-offset-4">BAGS</a>
      <a className="hover:underline underline-offset-4 " >HOME & LIVING</a>
      <a className="hover:underline underline-offset-4">SHOES</a>
    </ul>
        </div>}</>}
</>
